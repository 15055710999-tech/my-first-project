...
urlpatterns = [
    ...
    path("posts/my/liked/", views.my_liked_posts, name="my_liked_posts"),
    path("posts/<int:post_id>/", views.post_detail, name="post_detail"),
    path("posts/<int:post_id>/detail/", views.post_detail_with_like_status, name="post_detail_with_like_status"),
